#ifndef PJAVA_FUNCTIONS_H
#define PJAVA_FUNCTIONS_H
...
is_if_statement *insert_if_statement(is_instruction *ii, is_cont_statement *iconts, is_elseif_statement_list *ieisl,
...
is_elseif_statement_list *
insert_elseif_statement_list(is_elseif_statement_list *list_head, is_elseif_statement *ielseifs);
...
is_for_statement *
insert_for_statement(is_for_args *args1, is_relac_exp *ire, is_for_args *args2, is_cont_statement *icsta);
