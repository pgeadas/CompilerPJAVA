...
#line 144 "mycalc.y"
        {
            (yyval.iprogram) = PJAVAPROGRAM = insert_program((yyvsp[(2) - (5)].id), (yyvsp[(4) - (5)].iclass));
            return 0;
        }
            break;
...
#line 215 "mycalc.y"
        {
            (yyval.ifors) = insert_for_statement((yyvsp[(3) - (9)].ifa), (yyvsp[(5) - (9)].ire), (yyvsp[(7) - (9)].ifa),
                                                 (yyvsp[(9) - (9)].iconts));
        }
            break;
...
#line 224 "mycalc.y"
        {
            (yyval.iifs) = insert_if_statement((yyvsp[(3) - (7)].ii), (yyvsp[(5) - (7)].iconts),
                                               (yyvsp[(6) - (7)].ieisl), (yyvsp[(7) - (7)].ielses));
        }
            break;
...
#line 246 "mycalc.y"
        {
            (yyval.ifd) = insert_func_def((yyvsp[(2) - (7)].isymb), (yyvsp[(3) - (7)].id), (yyvsp[(5) - (7)].iargl),
                                          (yyvsp[(7) - (7)].icf));
        }
            break;
